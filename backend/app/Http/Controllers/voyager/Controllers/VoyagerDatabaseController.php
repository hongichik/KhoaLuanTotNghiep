...
class VoyagerDatabaseController extends Controller
{
    public function index()
    {
        ...
        return Voyager::view('vendor.voyager.views.tools.database.index')->with(compact('dataTypes', 'tables'));
    }
    ...
    public function create()
    {
        ...
        return Voyager::view('vendor.voyager.views.tools.database.edit-add', compact('db'));
    }
