...
class VoyagerBreadController extends Controller
{
    public function index()
    {
        ...
        return Voyager::view('vendor.voyager.views.tools.bread.index')->with(compact('dataTypes', 'tables'));
    }
    ...
    public function create(Request $request, $table)
    {
        ...
        return Voyager::view('vendor.voyager.views.tools.bread.edit-add', $data);
    }
    ...
    public function edit($table)
    {
        ...
        return Voyager::view('vendor.voyager.views.tools.bread.edit-add', compact('dataType', 'fieldOptions', 'isModelTranslatable', 'tables', 'dataTypeRelationships', 'scopes'));
    }
